<x-layout.app-layout title="Add Employee">
    <div class="container max-w-6xl mx-auto py-10">
        ...
        <form action="/create-employee" method="post" class="max-w-xl mx-auto rounded-lg shadow-lg mt-10 p-10 flex flex-col gap-4">
            @csrf
